...
export const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, overlayClassName, hideCloseButton = false, closeLabel, ...props }, ref) => {
  const t = useTranslations('common');
  const resolvedClose = closeLabel ?? t('close');
  return (
    <DialogPortal>
      ...
      >
        ...
        {!hideCloseButton && (
          ...
          >
            ...
            <span className="sr-only">{resolvedClose}</span>
          </DialogPrimitive.Close>
        )}
      </DialogPrimitive.Content>
    </DialogPortal>
