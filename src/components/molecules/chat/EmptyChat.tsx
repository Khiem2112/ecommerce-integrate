  ...
  return (
    <div className="grid h-full min-h-96 place-items-center bg-background px-6 text-center">
      <div className="max-w-sm">
        ...
        <h2 className="mt-4 text-base font-semibold tracking-tight text-foreground">{t('emptyTitle')}</h2>
        <p className="mt-1.5 text-sm leading-6 text-muted">{t('emptyDescription')}</p>
      </div>
    </div>
  );
}
