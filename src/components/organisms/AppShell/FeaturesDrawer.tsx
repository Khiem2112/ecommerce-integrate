      ...
      <DialogPortal>
        ...
        >
          ...
          <div className="flex h-11 shrink-0 items-center justify-between border-b border-hairline px-4">
            ...
            <DialogClose asChild>
              <IconButton
                ariaLabel={t('closeFeatureMenu')}
                tooltip={t('closeFeatureMenu')}
                variant="ghost"
                size="sm"
                icon={
                  <svg
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-3 p-6 text-center">
            ...
            <p className="text-sm font-medium text-foreground">{t('featureMenu')}</p>
            <p className="text-xs text-muted">{t('comingSoon')}</p>
          </div>
        </DialogPrimitive.Content>
      </DialogPortal>
    </Dialog>
