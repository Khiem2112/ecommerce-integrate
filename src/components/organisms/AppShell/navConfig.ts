...
export type NavItem = {
  ...
  readonly label: string;
  readonly href?: string;
  /** Inline SVG path data (Heroicons 2.x style, viewBox="0 0 24 24") */
...
export const getNavGroups = (t: Translate): readonly NavGroup[] => [
  {
    id: 'operations',
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [{ label: t('items.allCustomers'), href: '/customers' }],
      },
      {
        id: 'organizations',
    ...
    items: [
      {
        ...
        subItems: [{ label: 'Lazada', href: '/settings/integrations/lazada' }],
      },
    ],
  },
  {
