      ...
      >
        ...
        <header className="flex min-h-14 shrink-0 items-center justify-between border-b border-hairline bg-surface-lifted px-6 py-3">
          ...
          <div className="flex items-center gap-2">
            {customer && (
              ...
              >
                <Button type="button" variant="outline" size="xs">
                  <span className="mr-1">{t('quickView.openFullPage')}</span>
            ...
            <IconButton
              variant="ghost"
              size="sm"
              ariaLabel={t('quickView.closeModal')}
              tooltip={t('quickView.close')}
              onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
          ...
          {(error || (!isLoading && !customer)) && (
            <div className="m-4">
              <ErrorBanner
                message={`${t('quickView.loadFailed')}${error?.message ? ` ${error.message}` : ''}`}
